...
data = dict(
    train=dict(
        type='WUSULoader_single',
        params=dict(
            image_dir='/data1/yjx23/dataset/OpenWUSU512/train',
    ...
    test=dict(
        type='WUSULoader',
        params=dict(
            root='/data1/yjx23/dataset/OpenWUSU512/test',
            transforms=Compose([
    ...
    pseudo=dict(
        type='WUSULoader',
        params=dict(
            root='/data1/yjx23/dataset/OpenWUSU512/train',
            transforms=Compose([
                Normalize(mean=(0.485, 0.456, 0.406, 0.485, 0.456, 0.406),
                          std=(0.229, 0.224, 0.225, 0.229, 0.224, 0.225)),
                er.preprocess.albu.ToTensor()
