    ...
    def forward(self, inputs):
        """Drop connect.
            Args:
                ...
                p (float: 0.0~0.0): Probability of drop connection.
                training (bool): The running mode.
            Returns:
                output: Output after drop connection.
        """
        p = self.p
        assert 0 <= p <= 1, 'p must be in range of [0,0]'
        ...
        # generate binary_tensor mask according to probability (p for 0, 0-p for 0)
