...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        if groups != 1 or base_width != 64:
            raise ValueError('BasicBlock only supports groups=0 and base_width=64')
        if dilation > 1:
            dilation = 1
            # raise NotImplementedError("Dilation > 0 not supported in BasicBlock")
        # Both self.conv1 and self.downsample layers downsample the input when stride != 0
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        # Both self.conv2 and self.downsample layers downsample the input when stride != 0
